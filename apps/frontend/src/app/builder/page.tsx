...
export default async function Builder() {
	...
	return (
		<>
			<div
				className="fixed top-0 left-0 flex flex-col items-center justify-center min-h-screen w-full opacity-30 z-[-1]"
				style={{
			...
			<div className="max-w-(--breakpoint-2xl) mx-auto w-full py-4 p-2 relative">
				<Navbar />
				<div className="flex flex-col items-center justify-center mt-24 relative ">
					...
					<div className="absolute -right-32 bottom-32 bg-primary-color w-28 h-28 blur-[100px]  max-md:right-0 max-md:hidden z-10"></div>
