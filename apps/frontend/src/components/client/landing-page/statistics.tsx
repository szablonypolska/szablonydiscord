...
function StatisticsCard({ iconName, description }: Type) {
	return (
		<div className="flex flex-col items-center bg-boxColor border border-borderColor py-5 px-12 rounded-lg w-1/2 z-10 max-xl:px-8 max-lg:px-4">
			<div className="p-2 rounded-full w-fit bg-darkTealFade z-0 relative">
				<div className="bg-darkTealFade   rounded-full w-10 h-10 relative z-10">
					<span className="material-symbols-outlined absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primaryColor text-3xl">
						{iconName}
					</span>
				</div>
			</div>
	...
	return (
		<div className="max-md:w-full" ref={ref}>
			<h2 className="text-3xl max-md:text-center">
				Statystyki <strong className="text-primaryColor">systemów</strong>
			</h2>
			<p className="text-textColor mt-2 max-md:text-center">
			...
			<div className="flex gap-20 max-xl:gap-10 w-full mt-5 max-lg:flex-col max-lg:items-center max-lg:justify-center">
				<div className="w-1/2 bg-altBackgroundColor p-10 px-14 max-xl:px-5 max-lg:px-2 rounded-xl relative max-lg:w-full max-md:py-5">
				...
				<div className="mt-3 w-1/2 max-lg:text-center max-lg:w-full max-lg:flex max-lg:flex-col max-lg:items-center">
					...
					<div className="flex gap-10 h-28 mt-10 max-md:flex-col max-md:h-fit max-md:items-center max-md:w-full">
						<div className="">
							<p className="text-4xl text-primaryColor font-semibold">
								{inView && <CountUp start={0} end={2000} duration={2} />}
							</p>
							<p className="text-textColor mt-3 w-40">Szablonów serwerów discord</p>
						</div>

						<div className="w-0.5 h-full border-r border-dashed border-borderColor max-md:w-10/12 max-md:h-1 max-md:border-b  "></div>

						<div className="">
							<p className="text-4xl text-primaryColor font-semibold">
								{inView && <CountUp start={0} end={2215} duration={2} />}
							</p>
							<p className="text-textColor mt-3 w-40">Użykowników dodających szablony</p>
						</div>
						...
						<div className="">
							...
							<p className="text-textColor mt-3 w-40">Cykli skanowania szablonów</p>
						</div>
					</div>
					<Button className="bg-altBackgroundColor border border-borderColor rounded-full p-6 mt-12 flex items-center justify-center">
						Czytaj więcej
					</Button>
				</div>
			</div>
