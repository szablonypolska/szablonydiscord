...
import { Plus, MessagesSquare, Search, Clock } from "lucide-react"
...
export default function LackTicket() {
	return (
		<div className="flex flex-col items-center text-center p-4 py-5 h-80">
			...
			<Button className="flex items-center gap-2 bg-primaryColor mt-5 w-full rounded-lg">
				<Plus className="w-5 h-5" />
				<span className="text-sm">Nowe zgłoszenie</span>
			</Button>
			<div className="flex items-center justify-center w-full my-3">
				<div className="w-full h-[1px] bg-borderColor"></div>
				<p className="mx-2 text-textColor text-sm">Lub</p>
				<div className="w-full h-[1px] bg-borderColor"></div>
			</div>
