...
export default function HeaderTemplates() {
	return (
		<>
			<header className="flex items-center  my-20  relative px-10">
				<div className="relative w-1/2">
					...
					<div className="flex items-center gap-3 mt-5 w-[33rem] z-50 relative">
				...
				<Image src={searchDecoration} alt="test" className="flex justify-center w-1/2 h-96"></Image>
			</header>
		</>
	)
}
