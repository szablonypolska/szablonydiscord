...
export default async function MainContentBuilder() {
	...
	return (
		<div className="flex flex-col items-center justify-center mt-24 relative scale-105">
			<div className="absolute -left-32 bg-primaryColor w-28 h-28 blur-[100px] animate-pulse  max-md:blur-[100px] max-md:left-1/2 z-10"></div>
			<div className="absolute -right-32 top-96 bg-primaryColor w-28 h-28 blur-[100px] animate-pulse max-md:right-0 max-md:hidden z-10"></div>
