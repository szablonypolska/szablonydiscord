...
export default function MainContentBox() {
	return (
		<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.3 }} className="flex items-center gap-3 w-180 max-md:w-11/12 max-md:flex-col mt-5 z-10">
