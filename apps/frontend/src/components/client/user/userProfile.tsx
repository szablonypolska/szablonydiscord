		...
		<>
			<div className="flex max-md:flex-col gap-5 items-start my-32">
				<div className="max-md:w-full">
					<div className="flex flex-col items-center bg-box-color border border-border-color p-5 w-88 max-xl:w-72 max-md:w-full px-10 z-10 rounded-xl shrink-0">
						<div className="relative">
							...
							{data.register && (
								<Tooltip content="Zarejestrowane konto" className="bg-alt-background-color p-2 rounded-xl">
									<div className="absolute bottom-2 right-0 p-1.5 bg-primary-color w-fit rounded-full">
										<Check size="25" />
									</div>
								</Tooltip>
							)}
						...
						<p className="text-silver-color">({data.userId})</p>
