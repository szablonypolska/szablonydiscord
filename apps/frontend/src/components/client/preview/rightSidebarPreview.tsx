...
export default function RightSidebarPreview({ dataTemplate }: { dataTemplate: DiscordTemplate }) {
	return (
		<div className="bg-altBackgroundColor h-screen  w-[18rem] flex-shrink-0 transition-all  max-lg:w-0 overflow-hidden">
			<div className="flex items-center  gap-2 h-16 border-b border-b-borderColor p-3"></div>
			<div className="flex flex-col gap-2 p-3 px-4  h-[calc(100vh-4rem)] scrollbar scrollbar-thumb-altBorderColor scrollbar-track-borderColor  overflow-y-auto">
