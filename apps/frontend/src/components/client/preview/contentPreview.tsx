		...
		<div className="flex flex-col h-[calc(100vh-4rem)]">
			...
			<div className="w-full  p-3 px-5 max-lg:px-2">
				<div className="flex items-center gap-2">
					<div className="flex items-center justify-between bg-borderColor w-full p-4 rounded-xl px-5 max-lg:hidden">
					...
					<div className="flex items-center gap-2 w-full lg:hidden">
						<div className="bg-borderColor p-2 rounded-full w-10 h-10">
						...
						<div className="flex items-center justify-between bg-borderColor rounded-full p-2 h-10 flex-1 min-w-0 px-3 max-sm:px-2">
					...
					<div className="bg-borderColor text-gray-400 p-4 rounded-xl max-lg:hidden">
						<LayoutGrid />
					</div>
				</div>
			</div>
