		...
		<AnimatePresence>
			{settingsVisible && (
				<>
					...
					<motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }} exit={{ scale: 0.8 }} className="flex  fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[50rem] max-lg:w-11/12 bg-background rounded-lg min-h-[30rem] scale-105">
						<div className="w-64 bg-sidebar-color border-r border-border-color rounded-l-lg flex-shrink-0">
