		...
		<div className="bg-box-color p-5 rounded-xl grow max-lg:w-full">
			<div className="flex justify-between">
				<div className="flex items-center gap-3">
					<Clock className="text-silver-color" />
					<p>Limit na dzień</p>
				</div>
			...
			<div className="flex items-center justify-between mt-5">
				<div className="mt-2">
					...
					<p className="text-silver-color text-sm">z {dailyLimit} zapytań</p>
				</div>
				<div className="mt-2">
					<p className="text-2xl font-medium text-primary-color text-right">{percentUsageDay}%</p>
