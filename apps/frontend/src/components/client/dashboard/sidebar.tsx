...
export default function Sidebar() {
	...
	return (
		<>
			...
			<div className={`flex flex-col bg-sidebar-color border-r-2 border-border-color h-screen ${showSidebar ? "w-[18rem]" : "w-20 max-lg:w-0 max-lg:overflow-hidden"} transition-all duration-300 max-lg:absolute  z-20  `}>
				...
				<div className={`flex flex-col ${!showSidebar && "items-center max-lg:items-start"}  gap-3 mt-5 grow w-full px-3`}>
					...
					<div className="w-full">
						<Link href="/dashboard">
							<div className={`${pathname === "/dashboard" || pathname.includes("api") ? "bg-primary-color text-white" : "text-silver-color hover:bg-border-color"} px-2 w-full rounded-lg py-2 flex ${!showSidebar && "justify-center max-lg:justify-start"}  items-center gap-4 text-lg`}>
					...
					<div className="">
						<Link href="/dashboard/templates">
							<div className={`${pathname === "/dashboard/templates" ? "bg-primary-color text-white" : "text-silver-color hover:bg-border-color"} px-2 w-full rounded-lg py-2 flex ${!showSidebar && "justify-center"}  items-center gap-4 text-lg`}>
					...
					<div className="">
						<Link href="/dashboard/admin">
							<div className={`${pathname === "/dashboard/admin" ? "bg-primary-color text-white" : "text-silver-color hover:bg-border-color"} px-2 w-full rounded-lg py-2 flex ${!showSidebar && "justify-center"}  items-center gap-4 text-lg`}>
